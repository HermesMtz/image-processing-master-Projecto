var MathImg = /** @class */ (function () {
    ...
    MathImg.toTricolorHorizontal = function (img) {
        ...
        // Variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
        var inicio = 0, termino = img.getHeight() / 3; // Se cambio a img.getHeight()
        for (var j = 0; j < termino; j++) {
    ...
    MathImg.relativeBrightness = function (img) {
        ...
        for (var i = 0; i < img.getHeight(); i++) {
            for (var j = 0; j < img.getWidth(); j++) {
                ...
                //si no el brillo =0
                sal[0][i][j] =
                    Math.sqrt(Math.pow(arrImage[0][i][j], 2) * 0.299 +
                ...
                hue =
                    (180 / Math.PI) *
                        Math.acos((0.5 *
                            ...
                            Math.sqrt(Math.pow(arrImage[0][i][j] - arrImage[1][i][j], 2) +
                                (arrImage[0][i][j] - arrImage[2][i][j]) *
