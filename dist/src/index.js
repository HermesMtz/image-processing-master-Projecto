...
function convertirTricolorHorizontal(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.toTricolorHorizontal(imagenSal)
  );
}
////////////hasta aqui
function correccionGamma(evt) {
  var args = prompt(
    "Ingresa los factores de correccion Gamma, separados por coma"
  );
  var factores = args.split(",").map(function (elem) {
    return parseFloat(elem);
  });
  var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.correctionGamma(imagenSal, factores)
  );
}
...
function desfaseD(evt) {
  ...
  var rangos = args.split(",").map(function (elem) {
    return parseFloat(elem);
  });
  var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.toDesfaceD(imagenSal, rangos[0], rangos[1])
  );
}
function umbral2limites(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.toUmbral2limites(imagenSal, rangos)
  );
}
function changeBrightness(evt) {
  var factor = prompt(
    "Ingresa un valor en el rango de 0-2, como un porcentaje"
  );
  var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.changeBrightness(imagenSal, parseFloat(factor))
  );
}
function cambioFtransferencia(evt) {
  var args = prompt(
    "Ingresa los valores de la funcion de transferencia, separados por coma"
  );
  var factores = args.split(",").map(function (elem) {
    return parseFloat(elem);
  });
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.cambioFTransferencia(imagenSal, factores)
  );
}
function colorGradienteX(evt) {
  var args = prompt(
    "Ingresa color de Inicio y final en formato r,g,b, separados por coma"
  );
  var factores = args.split(",").map(function (elem) {
    return parseFloat(elem);
  });
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.colorGradienteX(imagenSal, factores)
  );
}
function colorGradienteY(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.colorGradientY(imagenSal, factores)
  );
}
function opchangeContraste(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.changeContraste(imagenSal, valor)
  );
}
function opgetPow(evt) {
  ...
  var valor = parseFloat(argss);
  var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla2,
    MathImg.pow(imagenSal, valor)
  );
}
function coseno(evt) {
  var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
...
function multiplicacion(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla2,
    MathImg.toMultiplication(imagenSal, valor)
  );
}
function subtract(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla2,
    MathImg.toSubtract(imagenSal, restar)
  );
}
...
function div(evt) {
  ...
  if (dividir === 0) {
    ...
    imagenSal.imageArray2DtoDataWithResizing(
      pantalla2,
      MathImg.toDividir(imagenSal, dividir)
    );
  } else {
    var imagenSal = new ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoDataWithResizing(
...
function marcaAguaCentro(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla2,
    MathImg.marcaAguaCentro(imagenSal, imagen2, 1)
  );
}
function marcaAguaArray(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla2,
    MathImg.marcaAguaArray(imagenSal, imagen2, porc)
  );
}
...
function textEfects(evt) {
  var args = prompt(
    "Ingresa texto, tamaño de texto y coord x y y, separados por coma:"
  );
...
function opchangeFalsoColor(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.fromHSItoRGB(
      MathImg.falseColorByHue(MathImg.fromRGBtoHSI(imagenSal), hue, 210)
    )
  );
}
function generarPulso(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.pulso(imgLocal.getImage().width, imgLocal.getImage().height)
  );
}
function generarRuido(evt) {
  ...
  imagenSal.imageArray2DtoData(
    pantalla2,
    MathImg.ruido(imgLocal.getImage().width, imgLocal.getImage().height)
  );
}
function generarRampaX(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla1,
    MathImg.rampaX(imgLocal.getImage().width, imgLocal.getImage().height)
  );
}
function generarRampaY(evt) {
  ...
  imagenSal.imageArray2DtoDataWithResizing(
    pantalla1,
    MathImg.rampaY(imgLocal.getImage().width, imgLocal.getImage().height)
  );
}
function escalarImagen(evt) {
  ...
  var imagenSal = new ImageType(
    pantalla2,
    null,
    Math.floor(imgLocal.getImage().width * factor),
    Math.floor(imgLocal.getImage().height * factor)
  );
...
function rotarImagen2(evt) {
  ...
  pantalla2.translate(
    Math.floor(imgLocal.getImage().width / 2),
    Math.floor(imgLocal.getImage().height / 2)
  );
...
function tAfin(evt) {
  var argss = prompt(
    "Ingresa 6 valores para t Afin, con x3<x1<x2 y y1<y2, y1<y3"
  );
  var factores = argss.split(",").map(function (elem) {
...
document
  ...
  .addEventListener("change", imgLocal4.handleFileSelect, false);
dropZone.addEventListener("dragover", handleDragOver, false);
dropZone.addEventListener("drop", imgLocal.handleFileSelect, false);
//menu op basicas
document
  .getElementById("op-gris")
  .addEventListener("click", convertirAGris, false);
document
  .getElementById("op-negativo")
  .addEventListener("click", convertirANegativo, false);
document
  .getElementById("op-neg-gris")
  .addEventListener("click", convertirANegativoGrises, false);
document
  .getElementById("op-rojo")
  .addEventListener("click", convertirARojo, false);
document
  .getElementById("op-verde")
  .addEventListener("click", convertirAVerde, false);
document
  .getElementById("op-azul")
  .addEventListener("click", convertirAAzul, false);
document
  .getElementById("op-tricolor")
  .addEventListener("click", convertirTricolor, false);
document
  .getElementById("op-tricolorhorizontal")
  .addEventListener("click", convertirTricolorHorizontal, false);
document
  .getElementById("op-gamma")
  .addEventListener("click", correccionGamma, false);
document
  .getElementById("op-umbral1")
  .addEventListener("click", umbralizado, false);
document
  .getElementById("op-umbral-2-limites")
  .addEventListener("click", umbral2limites, false);
document
  .getElementById("op-desfaseX")
  .addEventListener("click", desfaseX, false);
document
  .getElementById("op-desfaseY")
  .addEventListener("click", desfaseY, false);
document
  .getElementById("op-desfaseD")
  .addEventListener("click", desfaseD, false);
//menu op. edicion
document
  .getElementById("op-brillo")
  .addEventListener("click", changeBrightness, false);
document
  .getElementById("op-ftrans")
  .addEventListener("click", cambioFtransferencia, false);
document
  .getElementById("op-gradienteX")
  .addEventListener("click", colorGradienteX, false);
document
  .getElementById("op-gradienteY")
  .addEventListener("click", colorGradienteY, false);
document
  .getElementById("op-contraste")
  .addEventListener("click", opchangeContraste, false);
document
  .getElementById("op-falsocolor")
  .addEventListener("click", opchangeFalsoColor, false);
//op matematicas
...
document
  .getElementById("op-sine")
  .addEventListener("click", funcionSine, false);
...
document
  .getElementById("op-subtract")
  .addEventListener("click", subtract, false);
document
  .getElementById("op-multiplicacion")
  .addEventListener("click", multiplicacion, false);
...
document
  .getElementById("op-marca-agua-centro")
  .addEventListener("click", marcaAguaCentro, false);
document
  .getElementById("op-marca-agua-array")
  .addEventListener("click", marcaAguaArray, false);
//op con efectos
...
//histogramas
document
  .getElementById("op-hist")
  .addEventListener("click", histogramas, false);
document
  .getElementById("op-ecualizar")
  .addEventListener("click", ecualizado, false);
//mortfologia
document
  .getElementById("op-eros")
  .addEventListener("click", erosionarImg, false);
document.getElementById("op-dila").addEventListener("click", dilatarImg, false);
document
  .getElementById("op-aper")
  .addEventListener("click", aperturaImg, false);
document.getElementById("op-cier").addEventListener("click", cierreImg, false);
//operacion con imagenes siteticas
document
  .getElementById("op-pulso")
  .addEventListener("click", generarPulso, false);
document
  .getElementById("op-ruido")
  .addEventListener("click", generarRuido, false);
document
  .getElementById("op-rampax")
  .addEventListener("click", generarRampaX, false);
document
  .getElementById("op-rampay")
  .addEventListener("click", generarRampaY, false);
//operaciones geometricas
document
  .getElementById("op-escalamiento")
  .addEventListener("click", escalarImagen2, false);
document
  .getElementById("op-rotacion")
  .addEventListener("click", rotarImagen2, false);
document
  .getElementById("op-shearingX")
  .addEventListener("click", shearingX, false);
document
