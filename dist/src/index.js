...
var numberOfConfettiParticles = 200;
function initConfetti() {
    for (var i = 0; i < numberOfConfettiParticles; i++) {
...
function createRandomConfettiParticle() {
    ...
    var speedX = Math.random() * 4 - 2; // Velocidad horizontal aleatoria
    var speedY = Math.random() * 4 + 1; // Velocidad vertical aleatoria
...
function animateConfetti() {
    ...
    for (var i = 0; i < confettiParticles.length; i++) {
        var confettiParticle = confettiParticles[i];
...
//efecto opacidad 
var opacity = 1; // Inicializa la opacidad en 1 (completamente visible)
